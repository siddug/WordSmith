<%-- 
    Document   : editinfo
    Created on : 5 Nov, 2012, 10:13:02 PM
    Author     : varun
--%>
...
<html>
    ...
    <body>
        ...
        <div class="bg">
        	...
        	<br/><br/>
                <h1 style="font-size: 20px; margin-bottom:0px;">Personal Information</h1><br/>
        	<div id="info">First name: <%=firstname%> </div>
        	<div id="info">Last name: <%=lastname%></div>
        	<div id="info">Date of Birth: <%=dob%></div>
        	<div id="info">sex: <%=sex%></div>
        	<div id="info">Email id: <%=email%></div> <br/>
        	
                        <div id="edit_info" class="animate form" style="width:60%; margin-left:auto;margin-right:auto;">
                            <form  action="EditUserInfo" method="post" autocomplete="on"> 
                                <h1 style="font-size:20px;">Edit Info</h1> 
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Choose a new password </label>
                                    <input id="password" name="password" type="password" placeholder="eg. X8df!90EO" /> 
                                </p>
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Edit your first name </label>
                                    <input id="username" name="firstname" type="text" placeholder="eg. Siddhartha"/>
                                </p>
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Edit your last name </label>
                                    <input id="username" name="lastname" type="text" placeholder="eg. Gunti"/>
                                </p>
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Edit your email id </label>
                                    <input id="username" name="emailid" type="text" placeholder="eg. Siddhartha.gunti191@gmail.com"/>
                                </p>
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Edit your sex </label>
                                    <input id="username" name="sex" type="text" placeholder="eg. M"/>
                                </p>
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Edit your Date of birth </label>
                                    <input id="username" name="dob" type="text" placeholder="eg. 14/12/1992"/>
                                </p>
